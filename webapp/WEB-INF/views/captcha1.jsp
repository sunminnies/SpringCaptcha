...
<form method="POST" id="frm">
   ...
   <div class="g-recaptcha" data-sitekey="6LdqIwgbAAAAANZK0XwzWITYuk5BHsh3otcbOjS9" data-callback="onSubmit">
   </div>
...
어떤 사용자가 실제 사람인지 봇(컴퓨터프로그램)인지 구별하기 위해 사용하는 기법을 의미(튜링 테스트의 일종)
...
Google reCaptcha
구글에서 제공하는 봇 방지 API
버전1을 거쳐 지금 현재는 버전2(행위기반/반응기반)와 버전3(화면 로딩시 확인)이 주로 사용
